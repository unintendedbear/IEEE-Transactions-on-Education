...
\begin{table*}
	\caption[Odd ratios for every influence factor.]{Odd ratios (O.R.) that have been obatined depending on the decision of studying an engineering and the different factors of influence that we try to identify. An \textbf{$*$} indicates the statistically significant values.}
	\label{tab:oddratios}
	
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|c|}
		\hline
		Influence factor & Do you consider studying an engineering degree? & Gender & O.R. & Inferior limit & Superior limit \\ \hline
		...
		A/A+ in Mathematics & Yes & Boy & 2.059 & 0.599 & 7.076 \\ \hline 
		B/C (pass) in Mathematics & Yes & Boy & 1.728 & 0.505 & 5.919 \\ \hline
		A/A+ in Mathematics & Yes & Girl & 0.343 & 0.049 & 2.403 \\ \hline
		B/C (pass) in Mathematics & Yes & Girl & 0.250 & 0.030 & 2.057 \\ \hline
		A/A+ in Physics & Yes & Boy & 4.583$*$ & 1.398 & 15.030 \\ \hline 
		B/C (pass) in Physics & Yes & Boy & 3.000 & 0.946 & 9.513 \\ \hline
		A/A+ in Physics & Yes & Girl & 1.300 & 0.107 & 15.836 \\ \hline
		B/C (pass) in Physics & Yes & Girl & 1.000 & 0.096 & 10.471 \\ \hline
