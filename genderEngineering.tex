...
In the following Section we are going to present some initiatives that try to overcome the negative factors that have been presented, and look for a growth in the interest of girls over engineering.
...
\begin{IEEEbiography}{Paloma de las Cuevas}
Biography text here.
\end{IEEEbiography}
