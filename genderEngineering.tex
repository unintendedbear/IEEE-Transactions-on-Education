...
Another interesting comparison is the opinion of the students about the engineers and the work they perform. To gather their opinions a mutiple choice table was built, presenting a set of statements, to which the students had to mark if they agreed or disagreed (an \textit{``NS/NC''} option was also included). In Figure \ref{fig:opinions} we show a summary of the students' opinions about (from the botton to the top) whether an engineer has social prestige, has a good salary, has a creative job, their job is easy, has a good work schedule, and their work has an impact on the society. Only ``I agree'' responses have been taken into account for the sake of clarity in the graphic. It can be seen that in general, all surveyed students have a good opinion of what an engineer represents to the society and about the possibilities and creativity of their jobs. For the vocational courses, the thought of the engineers having good salaries highly decreases, which may be due to some of the students having already worked in STEM companies and experienced bad conditions. 

\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{img/opiniones.png}
  \caption{Responses to different statements made about an engineer per course. Students might agree, disagree, or choose not to give their opinion. Blocks from the bottom to the top are related to if the students think that whether an engineer has social prestige, has a good salary, has a creative job, their job is easy, has a good work schedule, and their work has an impact on the society.}
  \label{fig:opinions}
\end{figure}
