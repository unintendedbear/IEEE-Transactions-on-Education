...
Knowing the students is key for knowing the global status of the school before chosing the sample. The global distribution of students per course is displayed in Table \ref{tab:muestra}. In this table, it is indicated the number of students from the technical or ``science'' courses, which in the upper secondary courses approximately represents the 50\%, and almost the 31\% are in ``computer science'' or ``technology'' related vocational courses.
...
\begin{table*}
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
    	...
    	Vocational courses                            & 252 & 46 & 4  & 403 & 189 & 15 & $\geq$ 18  \\ \hline
    \end{tabular}
  \end{center}
\end{table*}
