...
\begin{itemize}
	\item \textbf{Research projects}. Funded by the European Union, the governments, or the universities themselves, aiming to go deeply into the reasons why women continue being unerrepresented in STEM and engineering or technology. Usually, the result of these research projects is a number of actions to take in order to respond to identified needs. However, they are almost never implemented. An example of these projects is the aforementioned ``Mind the Gap'' \cite{mtg:site}.
	\item \textbf{Groups and communities}. These are non-profit girl groups or ``clubs'' who are interested in technology and periodically gather to talk about technology or discuss about the situation of women in STEM. As they are non-profitable organisations, whenever they need resources such as places to gather or material, they can be sponsored by companies. In \cite{kira2012} there is a list of the most important organisations, classified by the specific purpose: encourage women in technology, share job offers, and share knowledge about programming, among other categories.
	\item \textbf{Code camps, campus, and occasional activities}. They are similar to the activities organised in groups or communities, but made non-periodically. Even if they are somehow periodical, for instance every year, they last a short period of time and look for a specific aim which is not to form an active community. Nonetheless, they can also be funded or sponsored by companies. Some os these activities take place at University of Granada, in Spain. More precisely, there are two summer camps: one for kids \cite{cinfant:site}, and another for teenager girls \cite{cchicas:site}.
\end{itemize}
